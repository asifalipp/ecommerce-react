...
export const addUser = (id, user) => collection(db, "users").doc(id).set(user);
export const setAuthPersistence = () => auth.setPersistence('LOCAL');

export const getUser = async (id) => {
  console.log(id)
  const documentId = 'BpFc0ORjbAaXtg7AQtTxAbVhUMV2';
